...
public class Player {
   ...
   * @throws IllegalArgumentException if name is null or empty, or
   *     startingMoney is null or non-positive
   */
  ...
  public void withdrawMoney(BigDecimal amount) {
    ...
    if (this.currentMoney.subtract(amount).compareTo(BigDecimal.ZERO) < 0) {
      throw new IllegalStateException(String.format(
          "Insufficient funds!! Current amount is: %s, Amount needed: %s",
