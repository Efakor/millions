...
/**
 * Factory class responsible for assembling the complete main game view.
...
public class AppFactory {
  ...
  public static MainView buildMainView(PlayerController playerController,
    ...
    StockDetailPanel stockDetailPanel = new StockDetailPanel(exchangeController,
        playerController, watchlistView);
