...
/**
 * Start screen view for Millions stock market simulator.
...
public class StartScreen extends VBox {
  ...
  private final Runnable gameStarted;
  ...
  public StartScreen(PlayerController playerController, Runnable gameStarted) {
    this.playerController = Objects.requireNonNull(playerController, "Player Controller cannot be null");
    this.gameStarted = Objects.requireNonNull(gameStarted, "Game started cannot be null");
