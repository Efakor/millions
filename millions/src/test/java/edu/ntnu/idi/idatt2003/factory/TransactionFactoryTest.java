...
public class TransactionFactoryTest {
  ...
  class InvalidTests {
    ...
    void createPurchase_nullWeek() {
      assertThrows(IllegalArgumentException.class, () -> TransactionFactory.createPurchase(null,1));
    }
    @Test
    ...
    void createPurchase_negativeWeek() {
      assertThrows(IllegalArgumentException.class, () -> TransactionFactory.createPurchase(share,-1));
    }
