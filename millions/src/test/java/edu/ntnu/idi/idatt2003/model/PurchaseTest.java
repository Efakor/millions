...
class PurchaseTest {
  ...
  /**
   * Tests that throws an exception when player has insufficient funds.
   */
  @Test
  ...
  /**
   * Tests that commit throws an exception when called on an already committed transaction.
   */
  @Test
